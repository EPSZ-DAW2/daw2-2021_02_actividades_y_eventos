 ...
 */
class confirmarForm extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            'confirmado' => 'Confirmar cuenta',
           ];
    }

    /**
     * {@inheritdoc}
     * @return confirmarQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new confirmarQuery(get_called_class());
    }
}
